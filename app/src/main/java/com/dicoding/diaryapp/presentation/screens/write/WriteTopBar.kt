    ...
    CenterAlignedTopAppBar(
        ...
        title = {
            Column {
                ...
                Text(
                    modifier = Modifier.fillMaxWidth(),
                    text = if (selectedDiary != null && dateTimeUpdated) "$formattedDate, $formattedTime" else if (selectedDiary != null) selectedDiaryDateTime else "$formattedDate, $formattedTime",
                    style = TextStyle(
        ...
        actions = {
            if (dateTimeUpdated) {
                IconButton(onClick = {
                    ...
                    updatedDateTime(ZonedDateTime.of(
                        currentDate,
                        currentTime,
                    ...
                    Icon(
                        ...
                        contentDescription = "Date Icon Close",
